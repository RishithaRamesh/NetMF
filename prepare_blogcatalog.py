...
EDGES_FILE = "data/BlogCatalog-dataset/data/edges.csv"
GROUP_EDGES_FILE = "data/BlogCatalog-dataset/data/group-edges.csv"
OUTPUT_FILE = "data/blogcatalog.mat"
...
def load_network():
    ...
    # Dataset IDs start at 1.
    # Python matrix indices start at 0.
    source = edges[:, 0] - 1
    target = edges[:, 1] - 1

    # BlogCatalog friendships are undirected,
    ...
    # Ensure duplicate edges do not produce values > 1.
    network.data[:] = 1.0
